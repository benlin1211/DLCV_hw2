...
if __name__ == '__main__':
    ...
    plt.title('(a) usps by class', fontsize=24)
    save_img_as = os.path.join(output_dir, f"Report 2-3 usps tsne by class.png")
    ...
    cb2 = plt.colorbar(boundaries=np.arange(3)-0.5).set_ticks(np.arange(2))
    plt.title('(b) usps by domain', fontsize=24)
    save_img_as = os.path.join(output_dir, f"Report 2-3 usps tsne by domain.png")
    plt.savefig(save_img_as)
