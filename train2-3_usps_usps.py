...
# Train on target domain usps, eval on target domain usps.
import os
import glob
import argparse
import random
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ckpt_dir", help="Checkpoint location", default="ckpt2-3_usps_usps")
    ...
    for epoch in range(n_epoch):
        ...
        len_dataloader =  len(train_dataloader_target)
        ...
        for i in range(len_dataloader):
            ...
            #  We don't training model using source data
